...
| `ALIGN_MIN_UNMARKED_PAUSE_SEC` | `0.45` | Silence needed to end a line with no waqf mark licensing it — a reciter may stop anywhere. Raise it if lines break mid-phrase. |
