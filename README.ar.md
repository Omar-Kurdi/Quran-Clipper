...
- **تصدير موجَّه إلى المنصة، لا إلى إطار واحد ثابت** — سبعة إعدادات جاهزة، وثلاث درجات دقة،
  ...
  `[Surah]_[surah]:[first]-[last]_[timestamp].mp4` — مثل `Al-Fatihah_1:1-7_1764503112000.mp4` —
  فتتجاور عدة نسخ من المقطع نفسه في مجلد واحد دون تعارض. ويُقرأ النطاق من المسار الزمني لا من
  الآيات التي طلبتها، فالمقطع المقصوص إلى الآيتين 2–3 يُسمّى `1:2-3` لا `1:1-7`. ويتبع الامتداد
  الملف المكتوب فعلًا — `.mp4` في التصدير إطارًا بإطار، و`.webm` في المسار البديل الفوري. ولا تسمح
  Windows بالنقطتين في أسماء الملفات، فيستبدل المتصفح حرفًا واحدًا عند الحفظ هناك.
