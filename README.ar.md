...
**التنسيق والتصدير**
- **قوالب جاهزة**: ستة مظاهر كاملة (الخط والألوان والبطاقة والخلفية وتعتيمها) في أعلى تبويب التنسيق،
  يُعرض كلٌّ منها مصغّرًا للإطار الذي يصنعه. ولا يغيّر القالب نسبة الأبعاد ولا الترجمات ولا الشارة ولا
...
| **المحلية + QUL** (`qul`) | الخدمة المساعدة و[ملفات QUL](#بيانات-qul) | تُكتشف من الصوت بمعونة QUL، أو تختاره أنت | **دقيق** — المحاذي نفسه |
...
المستودع، لأن `data/` غير متتبَّع. ومن دون هذه الملفات تقول الخيارات التي تحتاجها ذلك، ويعمل كل شيء
آخر كما كان.
...
QUL**. وليس في QUL تلاوة مقسّمة لرعد الكردي.
...
2. أو ارفع تلاوتك الخاصة — صوتًا **أو فيديو**. وفي حالة الفيديو، يقود صوته التوقيت ويعرض عليك مربّع
   ...
   - **المحلية + QUL** تفعل الشيء نفسه، وتستعين كذلك بجذور الكلمات والعبارات المتكررة من QUL لتجد
     المقطع. انظر [بيانات QUL](#بيانات-qul).
