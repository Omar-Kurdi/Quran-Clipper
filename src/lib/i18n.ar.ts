...
export const ar: Dictionary = {
  ...
  source: {
    ...
    step5: 'اضغط على كتلة لاختيار كلماتها وتحرير ترجمتها في اللوحة الجانبية.',
  ...
  match: {
    ...
    publishedTimed: (captions, source, pauses) =>
      pauses
  ...
  presets: {
    heading: 'قوالب جاهزة',
    help: 'مظهر كامل بنقرة واحدة: الخط والألوان والبطاقة والخلفية. وتبقى ترجماتك وشارة السورة والعلامة المائية ونسبة الأبعاد كما هي.',
    items: {
      'night-mosque': { name: 'مسجد الليل', note: 'المظهر الافتراضي للاستوديو: رسم المصحف على مسجد تحت القمر، بلمسات زرقاء هادئة.' },
      'gold-kaaba': { name: 'الكعبة الذهبية', note: 'ذهب دافئ فوق الكعبة، مع تعتيم وتمويه خفيفين.' },
      starlight: { name: 'ضوء النجوم', note: 'الخط الرقمي على سماء مرصّعة بالنجوم، بلا بطاقة، بلمسات بنفسجية فاتحة.' },
      minimal: { name: 'بسيط', note: 'بلا بطاقة ولا شارة ولا مؤشر صوت: خط عربي كبير مباشرة على سماء مموّهة.' },
      'madinah-green': { name: 'أخضر المدينة', note: 'المسجد النبوي بلمسات خضراء وبطاقة أعمق.' },
      indopak: { name: 'هندي', note: 'نستعليق هندي تحت مئذنة مقمرة، بلمسات كهرمانية.' }
    }
  },
  tour: {
    open: 'جولة تعريفية',
    progress: (step, total) => `الخطوة ${step} من ${total}`,
    skip: 'تخطٍّ',
    back: 'السابق',
    next: 'التالي',
    done: 'ابدأ الإنشاء',
    sourceTitle: 'اختر ما تصنعه',
    sourceBody:
      'اختر قارئًا وسورة وآيات، ثم «تحميل الآيات والصوت». أو ارفع تلاوتك، صوتًا أو فيديو، ودع المطابِق يجد المقطع ويوقّت كل كلمة.',
    sourceBodyCompact:
      'اختر قارئًا وسورة وآيات، ثم اضغط «تحميل الآيات والصوت» — أو ارفع تلاوتك ودع المطابِق يجد المقطع. والتبويبات بالأسفل تنقلك بين المصدر والمعاينة والتحرير.',
    timelineTitle: 'انقر لتزامن',
    timelineBody:
      'كل آية كتلة على المسار الزمني، طولها بطول تلاوتها. اضغط المسافة للتشغيل وB عند نهاية كل آية لتضبط حدّها، أو اسحب طرفَي الكتلة.',
    timelineBodyCompact:
      'كل آية كتلة على المسار الزمني، طولها بطول تلاوتها. شغّل التلاوة ثم اضغط ⚡ عند نهاية كل آية لتضبط حدّها، أو اسحب طرفَي الكتلة.',
    styleTitle: 'نسّقه ثم صدّره',
    styleBody:
      'في تبويب التنسيق كل ما يخص الشكل: نسبة الأبعاد والقوالب والخطوط والألوان والخلفية والبطاقة. وحين يعجبك، يصنع زر «تصدير» في الأعلى الفيديو.'
  },
  shortcuts: {
    open: 'الاختصارات',
  ...
  inspector: {
    ...
    arabic: 'النص العربي',
    arabicReadOnly: 'للقراءة فقط — اختر الكلمات الظاهرة من الأسفل',
    translation: 'الترجمة',
    ...
    wordsOnScreen: 'كلمات الآية',
    wordsHint: 'الكلمات المميّزة هي الظاهرة في هذا المقطع. اضغط على كلمة لإظهارها أو إخفائها.',
