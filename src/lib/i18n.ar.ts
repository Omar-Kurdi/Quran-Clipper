...
export const ar: Dictionary = {
  ...
  presets: {
    ...
    items: {
      ...
      starlight: { name: 'ضوء النجوم', note: 'الخط الرقمي في الثلث السفلي من سماء مرصّعة بالنجوم، بلا بطاقة، بلمسات بنفسجية فاتحة.' },
      ...
      indopak: { name: 'هندي', note: 'نستعليق هندي في أعلى الإطار تحت مئذنة مقمرة، مع وسم صغير في الزاوية، بلمسات كهرمانية.' }
    }
  },
  tour: {
    open: 'جولة تعريفية',
