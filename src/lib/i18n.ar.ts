...
export const ar: Dictionary = {
  ...
  inspector: {
    ...
    alsoAppears: (count, examples) =>
      count === 1
        ? `تَرِد هذه الكلمات أيضًا في ${examples}. يُستحسن التأكد من أن المقطع على الموضع الصحيح.`
        : `تَرِد هذه الكلمات أيضًا في ${count} مواضع أخرى — ${examples}${count > 4 ? '، وغيرها' : ''}. يُستحسن التأكد من أن المقطع على الموضع الصحيح.`,
    translationFollowsWords: 'ترجم هذه الكلمات وحدها',
    translationFollowsWordsHint:
      'يتبع النصُ أسفل العربي الكلماتِ المحدَّدة أعلاه بدل الآية كاملة، فلا يقول المقطع الذي يغطي نصف آية نصفَها الآخر. وهذه المعاني هي ترجمة quran.com الإنجليزية كلمةً كلمة — مصدر واحد لا مصدر لكل ترجمة — فتختلف الصياغة عمّا اخترتَ أعلاه، وتُقرأ ككلمات متتابعة، وتنطوي كلّ ترجمات البطاقة في هذا السطر الواحد. ونسبةُ الوصف تتبع ذلك. ويسري هذا على كل المقاطع.',
    oneGlossLine: count =>
      count === 1
  ...
  exportModal: {
    ...
    fastPathBody:
      'يدعم هذا المتصفح ترميز WebCodecs، فيُخرج المقطع بأقصى سرعة يبلغها الجهاز بدل الزمن الحقيقي — وقيس بين ٦ و١٠ أضعاف — ويُكتب بصيغة MP4. وخلفيات الفيديو تُفكّ إطارًا بإطار وتأتي معه. ويمكنك تبديل الألسنة أثناء العمل.',
