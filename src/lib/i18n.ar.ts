...
export const ar: Dictionary = {
  ...
  inspector: {
    ...
    translationFollowsWordsHint:
      'تتبع الترجمةُ أسفل النص العربي الكلماتِ المحدَّدة أعلاه بدل الآية كاملة، فلا يقول المقطع الذي يغطي نصف آية نصفَها الآخر. وانتبه أن هذه المعاني هي ترجمة quran.com كلمةً كلمة لا الترجمة المختارة أعلاه، فتختلف الصياغة وتُقرأ ككلمات متتابعة. ونسبةُ الوصف تتبع ذلك. ويسري هذا على كل المقاطع.',
