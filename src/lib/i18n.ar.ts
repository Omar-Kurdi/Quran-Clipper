...
export const ar: Dictionary = {
  ...
  inspector: {
    ...
    translationFollowsWordsHint:
      'تتبع الترجمةُ أسفل النص العربي الكلماتِ المحدَّدة أعلاه بدل الآية كاملة، فلا يقول المقطع الذي يغطي نصف آية نصفَها الآخر. وتُقرأ ككلمات متتابعة، لأن هذا شأن الترجمة كلمةً كلمة. ويسري هذا على كل المقاطع.',
