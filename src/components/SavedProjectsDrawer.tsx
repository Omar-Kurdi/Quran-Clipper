...
export const SavedProjectsDrawer: React.FC<SavedProjectsDrawerProps> = ({
  ...
  return (
            ...
            exportsList.map((exp) => (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-mono text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded" dir="ltr">
                    {exp.resolution}
                  </span>
                </div>
    ...
    <ConfirmDialog
        ...
        message={t.projects.confirmDeleteMessage(pendingDelete?.title ?? '')}
